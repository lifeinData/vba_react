...
class codeOptions extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <p topic="dq" className="menu-header-h1">
        ...
        <div className="code-option-box">
          <div className="option-select">
            <img
              onMouseEnter={() => {
                this.handleMouseHover("code-cp-tooltip-class");
              }}
              onMouseLeave={() => {
                this.handleMouseLeave("code-cp-tooltip-class");
              }}
              src={cpIcon}
              onClick={(e) => {
                this.copyToClipBoard("code-cp-tooltip-class");
              }}
            />
          ...
          <div className="option-select">
            <img
              onMouseEnter={() => {
                this.handleMouseHover("code-function-tooltip-class");
              }}
              onMouseLeave={() => {
                this.handleMouseLeave("code-function-tooltip-class");
              }}
              src={cpSectionIcon}
              onClick={() => {
                this.copyToClipBoard("code-function-tooltip-class");
              }}
            />
          ...
          <div className="option-select">
            <img
              onMouseEnter={() => {
                this.handleMouseHover("code-link-tooltip-class");
              }}
              onMouseLeave={() => {
                this.handleMouseLeave("code-link-tooltip-class");
              }}
              onClick={() => {
                this.copyToClipBoard("code-link-tooltip-class");
              }}
              src={cpLinkIcon}
            />
